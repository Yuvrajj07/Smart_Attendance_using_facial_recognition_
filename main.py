...
class Face_Recognition:
    def __init__(self, root):
        ...
        # First Image
        img = Image.open(r"C:\Face Recognition Attendence System\college_images\Stanford.jpg")
        ...
        # Second Image      
        img1 = Image.open(r"C:\Face Recognition Attendence System\college_images\facialrecognition.png")
        ...
        # Third Image
        img2 = Image.open(r"C:\Face Recognition Attendence System\college_images\u.jpg")
        ...
        # First row - Buttons
        # Student Button
        img4 = Image.open(r"C:\Face Recognition Attendence System\college_images\student.jpg")
        ...
        img5 = Image.open(r"C:\Face Recognition Attendence System\college_images\Faceimage.jpg")
        ...
        # Attendance Button
        img6 = Image.open(r"C:\Face Recognition Attendence System\college_images\report.jpg")
        ...
        # Help Desk Button
        img7 = Image.open(r"C:\Face Recognition Attendence System\college_images\help-desk-customer.jpg")
        ...
        b4_1 = Button(bg_img, text="Help Desk", cursor="hand2",
                      font=("times new roman", 15, "bold"), bg="darkblue", fg="white")
        b4_1.place(x=1100, y=300, width=220, height=40)

        # Second row - Buttons
        # Train Button
        img8 = Image.open(r"C:\Face Recognition Attendence System\college_images\train.jpg")
        ...
        # Photo Button 
        img9 = Image.open(r"C:\Face Recognition Attendence System\college_images\Photos.jpg")
        ...
        # Devloper Button 
        img10 = Image.open(r"C:\Face Recognition Attendence System\college_images\developer.jpg")
